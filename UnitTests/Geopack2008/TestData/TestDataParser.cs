...
{
    private const string ResourceName = "UnitTests.Geopack2008.TestData.OriginalDataSet.dat";

    /// <summary>
    /// Read data from original test data file
    /// generated by Tsyganenko's example code
    /// </summary>
    public static string ReadBasicOriginalDataFromFile()
    {
    ...
    public static TestData ParseTestData(string data)
    {
    ...
    public static void FillBasicOriginalDataSolarWindVelocity(this TestData testData)
    {
