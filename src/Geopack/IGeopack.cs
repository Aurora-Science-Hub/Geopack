...
public interface IGeopack
{
    ...
    /// </returns>
    ComputationContext Recalc(DateTime dateTime, CartesianVector<Velocity>? swVelocity = null);
    ...
    T GeoToMag<T>(ComputationContext context, T components) where T : ICartesian<T>;
    ...
    T MagToGeo<T>(ComputationContext context, T components) where T : ICartesian<T>;
    ...
    /// </remarks>
    /// <param name="context">Context containing pre-calculated coefficients. Must be generated by Recalc method.</param>
    /// <param name="components">Cartesian components (in [GEI] Re)</param>
    T GeiToGeo<T>(ComputationContext context, T components) where T : ICartesian<T>;
    ...
    /// <param name="context">Context containing pre-calculated coefficients. Must be generated by Recalc method.</param>
    /// <param name="components">Cartesian components (in [GEO] Re)</param>
    T GeoToGei<T>(ComputationContext context, T components) where T : ICartesian<T>;
    ...
    /// <param name="context">Context containing pre-calculated coefficients. Must be generated by Recalc method.</param>
    /// <param name="components">Cartesian components (in [MAG] Re)</param>
    T MagToSm<T>(ComputationContext context, T components) where T : ICartesian<T>;
    ...
    /// </remarks>
    /// <param name="context">Context containing pre-calculated coefficients. Must be generated by Recalc method.</param>
    /// <param name="components">Cartesian components (in [SM] Re)</param>
    T SmToMag<T>(ComputationContext context, T components) where T : ICartesian<T>;
    ...
    /// <param name="context">Context containing pre-calculated coefficients. Must be generated by Recalc method.</param>
    /// <param name="components">Cartesian components (in [SM] Re)</param>
    T SmToGsw<T>(ComputationContext context, T components) where T : ICartesian<T>;
    ...
    /// <param name="context">Context containing pre-calculated coefficients. Must be generated by Recalc method.</param>
    /// <param name="components">Cartesian components (in [GSW] Re)</param>
    T GswToSm<T>(ComputationContext context, T components) where T : ICartesian<T>;
    ...
    /// </remarks>
    /// <param name="context">Context containing pre-calculated coefficients. Must be generated by Recalc method.</param>
    /// <param name="startingPoint">Location GSW coordinates</param>
    ...
    /// <param name="exModel">External model providing components of the external magnetic field
    /// (e.g., T89, or T96_01, etc.)</param>
    /// <param name="inModel">Internal model providing components of the internal magnetic field
