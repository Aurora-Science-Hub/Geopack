...
public interface IT89
{
    ...
    /// <param name="bx">GSM x-component of the model magnetic field in nanoteslas</param>
    /// <param name="by">GSM y-component of the model magnetic field in nanoteslas</param>
    /// <param name="bz">GSM z-component of the model magnetic field in nanoteslas</param>
    void T89D_SP(
        int iopt,
        float[] parmod,
        float ps,
