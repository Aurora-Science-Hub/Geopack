...
|------- |---------- |---------- |---------:|----------:|----------:|------:|-------:|----------:|------------:|
| Recalc | .NET 10.0 | .NET 10.0 | 1.018 μs | 0.0038 μs | 0.0032 μs |  1.00 | 1.3828 |   2.83 KB |        1.00 |
|        |           |           |          |           |           |       |        |           |             |
| Recalc | .NET 8.0  | .NET 8.0  | 1.064 μs | 0.0039 μs | 0.0035 μs |  1.00 | 1.3828 |   2.83 KB |        1.00 |
