...
|------- |---------- |---------- |---------:|----------:|----------:|------:|-------:|----------:|------------:|
| Recalc | .NET 10.0 | .NET 10.0 | 1.016 μs | 0.0048 μs | 0.0042 μs |  1.00 | 1.3828 |   2.83 KB |        1.00 |
|        |           |           |          |           |           |       |        |           |             |
| Recalc | .NET 8.0  | .NET 8.0  | 1.057 μs | 0.0032 μs | 0.0030 μs |  1.00 | 1.3828 |   2.83 KB |        1.00 |
